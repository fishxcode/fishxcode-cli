...
export default withPwa(
  defineConfig({
          ...
          sidebar: [
            {
              ...
              items: [{ text: "Quick Start", link: "/en/quick-start" }],
            },
            {
              text: "Reference",
              items: [
      ...
      fr: {
        ...
        themeConfig: {
          ...
          sidebar: [
            {
              text: "Démarrage",
              items: [{ text: "Démarrage rapide", link: "/fr/quick-start" }],
            },
            {
              text: "Référence",
              items: [
      ...
      es: {
        ...
        themeConfig: {
          ...
          sidebar: [
            {
              text: "Comenzar",
              items: [{ text: "Inicio rápido", link: "/es/quick-start" }],
            },
            {
              text: "Referencia",
              items: [
      ...
      pt: {
        ...
        themeConfig: {
          ...
          sidebar: [
            {
              text: "Começar",
              items: [{ text: "Início rápido", link: "/pt/quick-start" }],
            },
            {
              text: "Referência",
              items: [
    ...
    themeConfig: {
      ...
      footer: {
        message:
          '<a href="https://fishxcode.com" target="_blank">主站</a> | <a href="https://doc.fishxcode.com" target="_blank">文档站</a> | <a href="https://github.com/fishxcode/fishxcode-cli" target="_blank">GitHub</a>',
